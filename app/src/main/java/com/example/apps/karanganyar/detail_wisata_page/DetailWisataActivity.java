package com.example.apps.karanganyar.detail_wisata_page;
...
import com.example.apps.karanganyar.API;
import com.example.apps.karanganyar.R;
import com.example.apps.karanganyar.map_page.MapActivity;
import com.example.apps.karanganyar.model.GooglePlaceSingleRespond;
import com.example.apps.karanganyar.model.Photo;
...
public class DetailWisataActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //load tombol back abu2 dan putih
    ...
    //ubah warna back button ketika di scroll
    ...
    //load data places dari places API
        ...
        call.enqueue(new Callback<GooglePlaceSingleRespond>() {
            ...
            public void onResponse(Call<GooglePlaceSingleRespond> call, Response<GooglePlaceSingleRespond> response) {
                ...
                if(response.body()!=null && response.body().getStatus().equals("OK")){
                    ...
                    //cek apakah ada data opening hour
    ...
    //ketika menklik tombol direction
