...
import com.example.apps.karanganyar.model.Leg;
...
import com.example.apps.karanganyar.model.Step;
...
//unutk decoding rute dari direction API
                    ...
                    for(int k=0;k<steps.size();k++){
                        ...
                        for(int l=0;l <list.size();l++){
                            ...
                            for (RedZone redZone : redzones){
                                ...
                                //jarak rute dengan titik berbahaya
                                 if(locationRedZone.distanceTo(locationStep) < 500  && (!dangerous)){
                                    dangerous = true;
