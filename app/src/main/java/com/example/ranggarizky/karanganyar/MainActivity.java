...
import com.example.ranggarizky.karanganyar.alertpage.GeofenceTrasitionService;
import com.example.ranggarizky.karanganyar.firstpage.FirstActivity;
import com.example.ranggarizky.karanganyar.historypage.HistoryActivity;
import com.example.ranggarizky.karanganyar.homepage.WisataRecycleAdapter;
import com.example.ranggarizky.karanganyar.model.GooglePlaceRespond;
import com.example.ranggarizky.karanganyar.model.HistoryLocation;
import com.example.ranggarizky.karanganyar.model.RedZone;
import com.example.ranggarizky.karanganyar.model.Result;
import com.example.ranggarizky.karanganyar.util.DBHandler;
import com.example.ranggarizky.karanganyar.util.DataFetchListner;
import com.example.ranggarizky.karanganyar.util.DataFetchWHereListner;
import com.example.ranggarizky.karanganyar.util.SessionManager;
...
public class MainActivity extends AppCompatActivity implements DataFetchListner, DataFetchWHereListner, SearchView.OnQueryTextListener, GoogleApiClient.ConnectionCallbacks,
    ...
    //WisataRecyclerAdapter2 adapter;
    ...
    private void loadRedZone() {
        ...
        call.enqueue(new Callback<ArrayList<RedZone>>() {
            ...
            public void onResponse(Call<ArrayList<RedZone>> call, Response<ArrayList<RedZone>> response) {
                ...
                historyLocation.setLong(112.720402);
                historyLocation.setLat(-7.283159);
                historyLocation.setAddress("Dukuh kupang timur XX, Surabaya");
                redZone.setLocation(historyLocation);
                apiresponse.add(redZone);

                redZone = new RedZone();
                historyLocation = new HistoryLocation();
                historyLocation.setLong(112.707919);
                historyLocation.setLat(-7.275916);
                historyLocation.setAddress("Dukuh kupang utara, Surabaya");
                redZone.setLocation(historyLocation);
